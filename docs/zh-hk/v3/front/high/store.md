...
### useKeepAliveStore()
頁面緩存管理，詳見 [前端緩存系統](/v3/front/advanced/cache.md#頁面緩存-keep-alive)
...
- [自動導入配置](/v3/front/advanced/auto-import.md) - Store 自動導入機制
- [前端緩存系統](/v3/front/advanced/cache.md) - 頁面和數據緩存
- [插件系統](/v3/front/high/plugins.md) - 插件開發與管理
- [請求與攔截器](/v3/front/advanced/request.md) - HTTP 請求中的 Store 使用