...
- 推薦通過[插件系統](/v3/front/high/plugins.md)替換登錄組件
...
詳細的 Token 刷新機制請參考 [請求與攔截器](/v3/front/advanced/request.md#token-刷新機制) 文檔。
...
- [系統配置詳解](/v3/front/advanced/system-config.md) - 系統全局配置説明
- [請求與攔截器](/v3/front/advanced/request.md) - HTTP 請求和 Token 管理
- [路由與菜單](/v3/front/base/route-menu.md) - 路由系統配置
- [插件系統](/v3/front/high/plugins.md) - 插件開發與配置
