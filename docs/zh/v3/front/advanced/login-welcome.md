...
- 推荐通过[插件系统](/v3/front/high/plugins.md)替换登录组件
...
详细的 Token 刷新机制请参考 [请求与拦截器](/v3/front/advanced/request.md#token-刷新机制) 文档。
...
- [系统配置详解](/v3/front/advanced/system-config.md) - 系统全局配置说明
- [请求与拦截器](/v3/front/advanced/request.md) - HTTP 请求和 Token 管理
- [路由与菜单](/v3/front/base/route-menu.md) - 路由系统配置
- [插件系统](/v3/front/high/plugins.md) - 插件开发与配置
- [后端认证机制](/v3/backend/security/passport.md) - 后端 JWT 认证实现
