...
このドキュメントでは、MineAdmin プラグイン開発の完全なサンプルを提供します。これには、さまざまなタイプのプラグインの実際のコード例とベストプラクティスが含まれています。

## 公式プラグインサンプル

### App-Store プラグイン (ハイブリッド型)

**リポジトリアドレス**: [mineadmin/appstore](https://github.com/mineadmin/appstore)

App-Store は MineAdmin 唯一の公式デフォルトプラグインであり、アプリケーションマーケット管理機能を提供し、ハイブリッド型プラグインの完全な実装を示しています。
...
以下は、完全なユーザー管理プラグインのサンプルであり、フロントエンドとバックエンドを含むハイブリッド型プラグインの開発方法を示しています。
...
### 2. バックエンド型プラグインサンプル - API サービスプラグイン

以下は、純粋なバックエンド API サービスプラグインのサンプルです。
...
以下は、純粋なフロントエンドのデータ可視化プラグインのサンプルです。
