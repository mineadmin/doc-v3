...
A secondary encapsulation of the `Form` component based on `Element Plus`, supporting all native form parameters, events, slots, and syntax, while also enabling configuration-based implementation.  
Additionally, it supports layout planning using `el-row` and `el-space`, featuring responsive design and mobile adaptation capabilities.
...
The following examples demonstrate various usage scenarios and advanced features of MaForm, from basic to complex applications. It is recommended to learn them in order for the best results.  
:::

### Basic Function Examples  
- [Basic Usage](/en/front/component/ma-form/examples/basic-usage) - Common form control configurations and usage  
...
- [Dynamic Validation](/en/front/component/ma-form/examples/dynamic-validation) - Custom validation rules and async validation  
...
- [Nested Forms](/en/front/component/ma-form/examples/nested-forms) - Managing complex hierarchical forms  
...
| `when` | Conditional rendering function, renders the item when returns true | `(model: Record<string, any>, item: MaFormItem) => boolean` | - | 1.0.0 |
| `dependencies` | Array of dependent fields, recalculates conditions when dependencies change | `string[]` | `[]` | 1.0.0 |
...
| Parameter     | Description                          | Type                                                                                                 | Default | Version |
|--------------|--------------------------------------|----------------------------------------------------------------------------------------------------|---------|---------|
| `mobileProps` | Mobile-specific component props configuration | `Record<string, any>` | `{}` | 1.0.0 |
