...
Additionally, it supports form layout planning based on `el-row` and `el-space`, featuring responsive design and mobile adaptation capabilities.
...
For official form parameters, please refer to the [Element Plus](https://element-plus.org/en-US/component/form.html) official documentation.
:::
...
The following examples demonstrate various usages and advanced features of MaForm, from basic usage to complex scenario applications. It is recommended to learn in order for the best results.
:::

### Basic Functionality Examples
- [Basic Usage](/en/front/component/ma-form/examples/basic-usage) - Basic configuration and usage of common form controls
...
- [Performance Optimization](/en/front/component/ma-form/examples/performance-demo) - Large form performance optimization strategies
...
| Parameter | Description | Type | Default | Version |
|-----------|-------------|------|---------|---------|
| `containerClass` | Custom class name for the form container, used for styling customization | `string` | - | 1.0.0 |
...
| Parameter | Description | Type | Default | Version |
|-----------|-------------|------|---------|---------|
| `cols` | Grid layout configuration, takes effect when `layout` is `flex`, supports responsive configuration | `ColsConfiguration` | - | 1.0.0 |
...
|------|-------------|----------------|---------|
| `default` | Default slot, can write native `<el-form-item>` tags, configuration approach automatically disabled when used | - | `<ma-form><el-form-item>...</el-form-item></ma-form>` |
