...
| `prop` | Field name, corresponding to the key in form data | `string` | - | 1.0.0 |
...
| `foldToggle()` | Toggle fold state | - | - | 1.0.0 |
| `getFold()` | Get current fold state | - | `boolean` | 1.0.0 |
...
- ✨ Basic search functionality support
