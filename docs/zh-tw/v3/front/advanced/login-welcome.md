...
- 推薦透過[外掛系統](/v3/front/high/plugins.md)替換登入元件
...
詳細的 Token 重新整理機制請參考 [請求與攔截器](/v3/front/advanced/request.md#token-重新整理機制) 文件。
...
- [系統配置詳解](/v3/front/advanced/system-config.md) - 系統全域性配置說明
- [請求與攔截器](/v3/front/advanced/request.md) - HTTP 請求和 Token 管理
- [路由與選單](/v3/front/base/route-menu.md) - 路由系統配置
- [外掛系統](/v3/front/high/plugins.md) - 外掛開發與配置
- [後端認證機制](/v3/backend/security/passport.md) - 後端 JWT 認證實現
