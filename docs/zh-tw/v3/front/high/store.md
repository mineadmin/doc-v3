...
### useKeepAliveStore()
頁面快取管理，詳見 [前端快取系統](/v3/front/advanced/cache.md#頁面快取-keep-alive)
...
- [自動匯入配置](/v3/front/advanced/auto-import.md) - Store 自動匯入機制
- [前端快取系統](/v3/front/advanced/cache.md) - 頁面和資料快取
- [外掛系統](/v3/front/high/plugins.md) - 外掛開發與管理
